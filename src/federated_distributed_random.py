...
# -*- coding: utf-8 -*-
"""
This script is used to run federated federated_distributed_random algorithm
...
Random select args.frac * args.num_users clients to train based on their local models in order,
the i th model is initialized from the i-1 th model.
"""
...
if __name__ == '__main__':
    ...
    file_name = '../save/objects/FedDistributed_random_{}_{}_O[{}]_C[{}]_iid[{}]_E[{}]_B[{}]_S[{}].pkl'. \
    ...
    with open(file_name, 'wb') as f:
        pickle.dump(
            {"train_accuracy": train_accuracy, "test_accuracy": test_accuracy, "train_losses": train_losses,
             "test_losses": test_losses, "runtime": time.time() - start_time},
            f)
