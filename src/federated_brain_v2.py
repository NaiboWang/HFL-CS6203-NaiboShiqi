...
# -*- coding: utf-8 -*-
"""
This script is used to run federated brain_v2 algorithm
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for r in range(args.num_users):
            ...
            # train local models for selected clients
    ...
    file_name = '../save/objects/FedBrain_v2_{}_{}_O[{}]_C[{}]_iid[{}]_E[{}]_B[{}]_S[{}].pkl'. \
